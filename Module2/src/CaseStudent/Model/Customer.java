...
public class Customer {
    ...
    public Customer(String name_customer, String id, Date birthday, String gender, int id_card, int phone_number, String email, String guest_type, String address, Services services) {
